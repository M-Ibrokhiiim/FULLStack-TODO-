...
export default function Delete({id,loading,setLoading}){
    ...
    return(
        <>
       <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"  onClick={()=>Click(id)} width={isActive ? "30" : "35"} height={isActive ? "34" :"35"} cursor={'pointer'} viewBox="0 0 64 64">
